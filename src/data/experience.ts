...
export const experience: Experience[] = [
  {
    ...
    skills: ["React", "PHP", "Laravel", "MySQL", "CI/CD", "Web hosting management", "Git", "REST APIs", "Scrum"],
  },
  {
    title: "Frontend Developer",
    company: "Zink In Tech",
    companyUrl: "https://zinkerp.com/",
    location: "Buenos Aires, Argentina",
    startDate: "Jul 2022",
    endDate: "Jul 2024",
    logo: "/logos/zink.png",
    ...
    skills: ["React", "ERP Systems", "Material UI", "Jira", "Agile"],
  },
  {
    title: "Full Stack Programmer",
    company: "Winpax",
    companyUrl: "https://winpax.com.ar/",
    location: "Buenos Aires, Argentina",
    startDate: "Aug 2021",
    endDate: "Jul 2022",
    ...
    skills: ["PHP", "MySQL", "Laravel","React", "Jquery", "Lumen", "Web hosting"],
  },
];
